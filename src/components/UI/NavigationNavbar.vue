<template>
    <nav class="bg-white w-full z-20 top-0 start-0 border-b border-gray-200">
        <div
            class="max-w-screen-xl flex flex-col lg:flex-row flex-wrap items-center justify-center md:justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full lg:flex md:w-auto md:order-1" id="navbar-user">
                <ul
                    ...
                    <li>
                        <NavLink :to="{ name: 'jornadas' }">Jornadas</NavLink>
                    </li>
